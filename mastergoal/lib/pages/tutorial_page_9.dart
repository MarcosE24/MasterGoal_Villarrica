...
class TutorialPage9 extends StatefulWidget {
  const TutorialPage9({super.key});

  @override
  State<TutorialPage9> createState() => _TutorialPage9State();
}

class _TutorialPage9State extends State<TutorialPage9> {
  @override
                ...
                children: const [
                  Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        "La pelota no puede terminar en posecion de un equipo contrario al final del turno",
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 16,
                          //fontFamily: "Gilroy",
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(
                      height: 400,
                      width: 400,
                      child: Image.asset('assets/T9.png'),
                    ),
                  ],
                ),
              ),
